document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('http://localhost/teste/backend/get_disciplinas.php')
    ...
    document.getElementById('btn-next-disciplinas').addEventListener('click', () => {
        ...
        fetch(`http://localhost/teste/backend/get_turmas.php?disciplina=${disciplinaSelecionada}`)
            .then(response => response.json())
            .then(turmas => {
    ...
    document.getElementById('material-form').addEventListener('submit', (e) => {
        ...
        fetch('http://localhost/teste/backend/enviar_material.php', {
            method: 'POST',
            body: formData,
        })
        ...
        .then(result => {
            ...
            //alert(result); // Opcional: mostra o retorno da requisição no console
